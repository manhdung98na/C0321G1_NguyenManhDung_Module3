...
public class UserRepositoryImpl implements UserRepository {
    ...
    public List<User> selectAllUsersByProcedure() throws SQLException {
        List<User> list = new ArrayList<>();
        String callProcedure = "{CALL get_list_user()}";
        Connection connection = DBConnection.getConnection();
    ...
    public boolean updateUserByProcedure(User user) throws SQLException {
        ...
        String callProcedure = "{CALL update_user(?, ?, ?, ?)}";
        Connection connection = DBConnection.getConnection();
        CallableStatement callableStatement = null;
        if (connection != null) {
            try {
    ...
    public boolean deleteUserByProcedure(int id) throws SQLException {
        String callProcedure = "{CALL remove_user(?)}";
        Connection connection = DBConnection.getConnection();
        CallableStatement callableStatement = null;
    ...
    @Override
    public void addToUserTableTransaction(User[] users) {
        ...
        try {
            ...
            for (User o : users) {
                ...
                callableStatement.setString(2, o.getEmail());
                callableStatement.setString(3, o.getCountry());
                callableStatement.executeUpdate();
            }
            connection.commit();
